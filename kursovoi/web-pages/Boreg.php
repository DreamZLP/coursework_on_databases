<?php
include '../functions/check_for_reg.php';
...
<html lang="ru">
  ...
  <div class="container">
	<form method="post" action="" name="signup-form">
		...
		<div class="container">
		  <label for="full_name"><b>Фамилия и Имя</b></label>
		  <input type="text" placeholder="Введите ваши Фамилие и Имя" name="full_name" required>
		  <label for="username"><b>Логин</b></label>
		  <input type="text" placeholder="Придумайте логин" name="username" required>
		  ...
		  <div class="row">
				<div class="col-6">
				<a class="back_main" href="Boauth.php">Уже зарегистрированы? Войдите!</a>
				</div>
				<div class="col-6">
